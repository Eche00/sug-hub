...
export default function AboutPage() {
  return (
    <main className=" bg-linear-to-b from-gray-50 to-white rounded-2xl overflow-hidden">
      {/* Hero Section with H1 */}
      <section className="relative bg-linear-to-r from-green-600 to-blue-800 text-white py-20 ">

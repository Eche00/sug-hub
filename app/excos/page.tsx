...
export default function ExcosPage() {
  ...
  const [showModal, setShowModal] = useState(false); // Simple modal state
            ...
            <div className="flex items-center justify-between mb-6 px-4 sm:px-0">
              ...
              <div className="flex items-center gap-4">
                <div className="text-gray-600 hidden sm:block">
                  <span className="font-medium py-1 px-2 rounded-full bg-green-800 text-white">
                    {currentExcos.length}
                  </span> members
                </div>
              </div>
              ...
              <div className="overflow-x-auto overscroll-x-contain scrollbar-hide">
                <div className="flex gap-4 px-4 sm:px-6 py-4 w-max">
                  {currentExcos.map((exco: Executive) => (
                    <div 
                      key={exco.id} 
                      onClick={handleEditClick} // Click anywhere on card to open modal
